  ...
  return (
    <>
      <section className='py-5 flex justify-between px-52 bg-[#20202C]'>
        <div className='w-50'>
          <img src={Logo} className="inline-block  w-50" alt="logo" />
        ...
        <div>
          <h4 className='text-white text-xl fw-bold pb-2' style={{borderBottom : ' solid 4px #FF8000'}}>Links</h4>
        ...
        <div>
          <h4 className='text-white fw-bold text-xl pb-2' style={{borderBottom : ' solid 4px #FF8000'}}>Contact us</h4>
